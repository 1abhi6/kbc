...
questionList = [
    ...
    ['Q4.Bureau of Police Research and Development (BPRD) is an organisation under which Union Ministry?', 'Ministry of Home Affairs',  'Ministry of Law and Justice',
    ...
    ['Q6.What is the name of the mission undertaken by the Indian Navy, to bring back Indian citizens from overseas during the COVID-19 pandemic?', 'Operation Samudra Setu', 'Operation Sukoon',
        'Vande Bharat Mission', 'Operation Rahat', 1],

    ['Q7.Solar Energy Corporation of India is a public sector undertaking working under which Union Ministry?', 'Ministry of New and Renewable Energy', 'Ministry of Power',
    ...
    ['Q12.A committee has been formed by which Union Ministry for study on origin of Indian culture?', 'Ministry of Culture', 'Ministry of Home Affairs',
    ...
    ['Q16.The Supreme Court appointed a committee under which eminent person to take steps for preventing stubble burning?', 'Justice Madan B Lokur', 'Justice Ranjan Gogoi',
        'Justice Dipak Misra', 'Justice Jagdish Singh Khehar', 1]
]
# Code
amount = 0
